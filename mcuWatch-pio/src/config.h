...
-----       -----       -----       -----       -----       -----       -----
SCK         3           D9          D13*)       D5/GPIO14*)             SCL,
HSCLK, SPI Clock, Hardware SPI clk SDA         4           D8          D11*)
D7/GPIO13*)             SPI Data, MOSI, HMOSI, data to screen RES         5 D7
D5          D6/GPIO12*)             RST, HMISO, screen reset DC          6 D6 D4
D4/GPIO2                Register Select, labelled as DC in Adafruit code CS 7 D5
D3          D3/GPIO0                Chip Select, defined as Slave Select in SPI
